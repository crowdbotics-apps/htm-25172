...
admin.site.site_header = "HTM"
admin.site.site_title = "HTM Admin Portal"
admin.site.index_title = "HTM Admin"

# swagger
api_info = openapi.Info(
    title="HTM API",
    default_version="v1",
    description="API documentation for HTM App",
)
